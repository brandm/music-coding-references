* Summary
  - This is a collection of references to live code music.
  - Each top level section after "Miscellaneous" is dedicated to one of the
    tools used to live code music, there are many more than listed here.
...
***** Bret Victor - Talk: Inventing on Principle :@:
      ...
      - Video on Vimeo: http://vimeo.com/36579366
      - Transcript:
        - Blog with comments:
...
***** Live debugging in Python with live-py-plugin :@:
...
*** Hy (Lisp on Python)
    - Don't miss this wonderful Lisp. Its source is translated to a Python
      AST like any "normal" Python code and then takes the usual Python
      path: The AST is compiled into byte code and executed like any
      module.pyc.
